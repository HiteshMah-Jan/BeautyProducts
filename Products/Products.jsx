...
class Products extends React.Component {
    ...
    componentDidMount() {
      ...
      fetch('https://beautyhub.pro/ajax/react_view.php', requestOptions) //https://beautyhub.pro/ajax/react_view.php
    ...
    handleChange = e => {
      const arrayProducts = this.state.Products.filter(a => a.id),
    ...
    render(){
      const {variantIt, hide, value, Products, ProductsFilterTable, ProductsFilterTableHide, clickModalView} = this.state,
